...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const nodemailerMailAdpater = new nodemailer_mail_adapter_1.NodemailerMailAdpater();
    const submitFeedbackUseCase = new submit_feedback_use_case_1.SubmitFeedbackUseCase(prismaFeedbacksRepository, nodemailerMailAdpater);
